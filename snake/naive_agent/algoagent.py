...
class AlgoAgent(object):
    ...
    def arr_to_state(self, obs_arr):
        ...
        _, food_dir, food_arr = self.find_food(head, food)
        if food_dir == -1:
            return -1, -1
    ...
    def update(self, obs_arr, reward, action, info):
        ...
        # print("changing state from", self.state_arr, " to ", next_state_arr)
